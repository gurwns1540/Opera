...
public class ResearchTarget {
	...
	public ResearchTarget(int targetNo, String targetGender, String targetAgeRange, String targetLocation, int minAge, int maxAge,
			int researchNo, int occupationNo, int additionalEtc) {
		super();
