...
<body>
	...
	<div id="adminBox">
			...
			<tr>
				<td>
					<div id="approvalBtnArea">
						<button onclick="location.href='researchWaitingPayment.admin'">폐기응답 목록</button>
						<button onclick="location.href='researchConsultationCompleted.admin'">불량응답관리</button>
					</div>
				</td>
			</tr>
			<tr>
		...
		<table id="listTable">
			<tr id="tableTitle">
				<th style="width: 35%;">폐기응답번호</th>
				<th style="width: 35%;">패널회원번호</th> <!-- 아이디아님 -->
				<th style="width: 30%;">상세보기</th>
			</tr>
