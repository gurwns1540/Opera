...
<body>
	...
	<script>
		...
		$(document).on("click", ".plusBtn2", function(){
			...
			}else if($("#editingMain").find("#questionFormNo").val() == ""){
				Swal.fire({
					icon: 'error',
					title: 'Oops...',
					text: '질문 내용을 작성해 주세요.',
