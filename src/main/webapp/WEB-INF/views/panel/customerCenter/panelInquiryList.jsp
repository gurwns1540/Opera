					...
					<table style="width: 100%;">
						<tr>
							<td style="height: fit-content;">
								<form action="searchInquiry.customerCenter"
									method="post">
									<div id="searchInput">
										<div class="ui action input">
											<input type="text" name="searchInquiry"
												placeholder="패널/기업 명을 입력하세요">
									...
									<select class="ui dropdown" name="category" id="userType" style="float: right;">
					...
					<tbody id="newInquiryTbodyArea">
						<tr>
							...
							<td style="text-align: left;">
								<div class="ui selection dropdown" style="margin-left: 31px; float:left !important;">
